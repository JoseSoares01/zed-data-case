...
export function MusicPlayer({ autoStart = true }: { autoStart?: boolean }) {
  ...
  return (
    <div className="absolute top-20 right-4 z-50 flex items-center gap-2 rounded-full border border-ink/15 bg-cream/90 backdrop-blur-md px-3 py-2 shadow-lg lg:top-28">
