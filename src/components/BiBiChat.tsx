  ...
  return createPortal(
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 md:top-1/2 md:-translate-y-1/2 md:bottom-auto md:left-auto md:right-6 z-[9998] group flex flex-col items-center md:flex-row md:items-center md:gap-2"
      >
        {!open && (
