...
export function BiBiChat() {
  ...
  return createPortal(
    <>
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-24 right-4 left-4 md:left-auto md:top-32 md:bottom-auto md:right-6 z-[9999] md:w-[calc(100vw-3rem)] max-w-sm h-[26rem] md:h-[28rem] flex flex-col rounded-3xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] bg-black/35 backdrop-blur-2xl border border-white/15 overflow-hidden animate-[bibi-in_0.25s_ease-out]">
