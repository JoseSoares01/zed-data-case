        ...
        <Editable id="Hero" label="Hero"><section id="s0" className="grid lg:grid-cols-2 gap-6 pt-10 lg:pt-14">
          ...
          <div className="relative self-start">
            ...
            >
              ...
              {/* Mobile: vertical stack of left-side icons */}
              <div
                className="absolute md:hidden left-4 top-1/2 -translate-y-1/2 flex flex-col gap-4 z-20"
              >
                <a
                  href="#portfolio"
                  className="rounded-full bg-[#f5a623] flex items-center justify-center text-ink hover:scale-105 transition-transform w-9 h-9"
                  style={{
                    border: "3px solid #fff",
                    boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                  }}
                ...
                <a
                  href="#sobre"
                  className="rounded-full bg-[#f5a623] flex items-center justify-center text-ink hover:scale-105 transition-transform w-10 h-10"
                  style={{
                    border: "3px solid #fff",
                    boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                  }}
                ...
                <a
                  href="#projetos"
                  className="rounded-full bg-ink flex items-center justify-center text-cream hover:scale-105 transition-transform w-9 h-9"
                  style={{
                    border: "3px solid #fff",
                    boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                  }}
              ...
              {/* Desktop: individually positioned left-side icons */}
              {/* Camera icon – overlay (image 4.96%, 68.39%; container-corrected 5.00%, 67.80%) */}
              <a
                href="#portfolio"
                className="hidden md:flex absolute rounded-full bg-[#f5a623] items-center justify-center text-ink z-20 hover:scale-105 transition-transform w-[76px] h-[76px] [left:calc(5.00%-38px)] [top:calc(67.80%-38px)]"
                style={{
                  border: "3px solid #fff",
                  boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                }}
              ...
              <a
                href="#sobre"
                className="hidden md:flex absolute rounded-full bg-[#f5a623] items-center justify-center text-ink z-20 hover:scale-105 transition-transform w-[88px] h-[88px] [left:calc(5.17%-44px)] [top:calc(79.30%-44px)]"
                style={{
                  border: "3px solid #fff",
                  boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                }}
              ...
              <a
                href="#projetos"
                className="hidden md:flex absolute rounded-full bg-ink items-center justify-center text-cream z-20 hover:scale-105 transition-transform w-[76px] h-[76px] [left:calc(5.02%-38px)] [top:calc(90.88%-38px)]"
                style={{
                  border: "3px solid #fff",
                  boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                }}
