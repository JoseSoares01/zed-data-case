        ...
        <Editable id="Hero" label="Hero"><section id="s0" className="grid lg:grid-cols-2 gap-6 pt-10 lg:pt-14">
          ...
          <div className="relative self-start">
            ...
            >
              ...
              <a
                href="#contato"
                className="absolute rounded-full bg-ink flex items-center justify-center z-20 top-[4%] right-[5%] hover:scale-105 transition-transform w-[44px] h-[44px] md:w-[88px] md:h-[88px] translate-x-[8px] translate-y-[10px] md:translate-x-[-16px] md:translate-y-[16px]"
                style={{
              ...
              <div
                className="absolute flex flex-col gap-3 md:gap-1 z-20 top-[58%] left-[15%] md:top-[63%] md:left-[7%]"
              >
                <a
                  href="#portfolio"
                  className="rounded-full bg-[#f5a623] flex items-center justify-center text-ink hover:scale-105 transition-transform w-[36px] h-[36px] md:w-[76px] md:h-[76px] translate-x-[4px] translate-y-[1px] md:translate-x-[-32px] md:translate-y-[-16px]"
                ...
                <a
                  href="#projetos"
                  className="rounded-full bg-ink flex items-center justify-center text-cream hover:scale-105 transition-transform w-[36px] h-[36px] md:w-[76px] md:h-[76px] translate-x-[4px] translate-y-[1px] md:translate-x-[-32px] md:translate-y-[-16px]"
                  style={{ border: "3px solid #fff", boxShadow: "0 12px 35px rgba(0,0,0,0.18)" }}
                >
