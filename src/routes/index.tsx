        ...
        <Editable id="Hero" label="Hero"><section id="s0" className="grid lg:grid-cols-2 gap-6 pt-10 lg:pt-14">
          ...
          <div className="relative self-start">
            ...
            >
              ...
              <a
                href="#portfolio"
                className="absolute rounded-full bg-[#f5a623] flex items-center justify-center text-ink z-20 hover:scale-105 transition-transform w-[36px] h-[36px] md:w-[84px] md:h-[84px] [left:calc(5.00%-18px)] [top:calc(67.80%-18px)] md:[left:calc(6%-42px)] md:[top:calc(62%-42px)]"
                style={{
                  border: "3px solid #fff",
                  boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                }}
              ...
              <a
                href="#sobre"
                className="absolute rounded-full bg-[#f5a623] flex items-center justify-center text-ink z-20 hover:scale-105 transition-transform w-[40px] h-[40px] md:w-[84px] md:h-[84px] [left:calc(5.17%-20px)] [top:calc(79.30%-20px)] md:[left:calc(6%-42px)] md:[top:calc(78%-42px)]"
                style={{
                  border: "3px solid #fff",
                  boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                }}
              ...
              <a
                href="#projetos"
                className="absolute rounded-full bg-ink flex items-center justify-center text-cream z-20 hover:scale-105 transition-transform w-[36px] h-[36px] md:w-[84px] md:h-[84px] [left:calc(5.02%-18px)] [top:calc(90.88%-18px)] md:[left:calc(6%-42px)] md:[top:calc(94%-42px)]"
                style={{
                  border: "3px solid #fff",
                  boxShadow: "0 12px 35px rgba(0,0,0,0.18)",
                }}
