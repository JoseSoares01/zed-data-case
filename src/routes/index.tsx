        ...
        <Editable id="Hero" label="Hero"><section id="s0" className="grid lg:grid-cols-2 gap-6 pt-10 lg:pt-14">
          ...
          <div className="relative self-start">
            ...
            >
              ...
              <a
                href="#contato"
                className="absolute rounded-full bg-ink flex items-center justify-center z-20 top-[3%] right-[2%] hover:scale-105 transition-transform w-[44px] h-[44px] md:w-[88px] md:h-[88px] translate-x-[-6px] translate-y-[6px] md:translate-x-[-16px] md:translate-y-[16px]"
                style={{
